format ELF64 executable 3 at 0_F000_0000h
entry Start
...
_code     Start:              fprintf(**stderr, <"An error message.",10,0>);
...
;
;   fprintf(*stdout, <"Any text.",10,0>);                   ; legacy *way;
;   fprintf([stdout], <"It does the same as above",10,0>);  ; classical [way];
;   fprintf(stdout, "A much modern fastcall v3 approach!"\n); modern way;
;
