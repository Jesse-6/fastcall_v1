format ELF64 executable 3 at 1_0000_0000h
...
_bss      buffer1:                 rd 128    ; A 'by reference' (address pointer) type variable 
          buffer2                  rd 128    ; A 'by value' ([data] at memory) type data variable
...
_code rwx     ; self modifying code section!
          ...
          align 32
          Start entry:             inc       [testcnt] ; test write capabilities
                              ...
                              @@   mfence
                                   ...
                                   mov       [buffer2+32], 12345678
                                   printf(\n "Data at varible: %u"\n, buffer2+32);
                                   printf("Address of variable: 0x%lX"\n, buffer1+32);
