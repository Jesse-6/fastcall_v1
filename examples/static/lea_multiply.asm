...
_code entry $ 
                                ...
                                cmp         ebx, eax
                                ja          err2
                                fputs("Multiply demo using only lea instruction"\n, stdout);
                                ...
                                fputs(\n "Done."\n, stdout);
                                exit(0);
        err2:                   fputs("Number too big"\n, stderr);
                                exit(3);
        err1:                   fputs("Invalid number"\n, stderr);
                                exit(1);
        help:                   fputs("Type: 'lea_multiply NNN', where NNN is any 32 bit number"\n, stderr);
                                exit(2);
