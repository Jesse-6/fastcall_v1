...
_code   Start entry:            endbr64
        ...
        Main:                   endbr64
                                ...
                                mov         r14, rax
                                g_signal_connect(rax, "destroy", GOT.gtk_main_quit, NULL);
            ...
            .err:               fputs("Could not initialize libnotify"\n, stderr);
        ...
        WinClose:               endbr64
                                ...
                                fputs("Okay, I'm leaving now..."\n, stdout);

                                add         rsp, 8
                                ret

; To compile: > ./build GTK3 lib-notify2 -lnotify
