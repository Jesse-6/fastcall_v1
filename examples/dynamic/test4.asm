...
_code   Start:                  ; "bare metal" code segment
                                endbr64
                                movq        mm5, [stdout]
                                fprintf(mm5, <"File descriptor for ", 27, "[1;30m", \
                                    ...
                                    ("E"), ("F"), mm5);
                                fprintf(mm5, "Hex value of chars: %016lX."\n, ("Jessé!"));
                                fputs("This is a test."\n, mm5);    ; Trusting MMX register value
                                fprintf(mm5, "True: %u."\n, TRUE);  ; preservation across calls is
                                fprintf(mm5, "False: %u."\n, FALSE);; risky. Don't do it in production code!
                                finit   ; (²)

        ; This will be attached to end of _bss output area above
_bss    dummy                   dq ?
        endptr                  dd ?

; close virtual data above and restore the bare metal code segment from previous point (²)
_code                           fldpi
                                fxch        st6
                                nop
                                nop     ; (¹)
